    ...
    <div className="min-h-[75vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl border border-slate-100 shadow-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold font-heading text-slate-900">Welcome Back</h2>
          <p className="text-slate-500 text-xs">Sign in to access your NK Enterprises account</p>
        </div>
        ...
        <div className="text-center text-xs text-slate-500 pt-2">
          ...
          <Link to={`/register?redirect=${redirect}`} className="text-[#2D6A75] font-bold hover:underline">
            Register Here
          </Link>
        </div>
      </div>
